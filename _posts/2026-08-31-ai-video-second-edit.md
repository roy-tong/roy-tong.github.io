...
所以，“支持局部修改”不应只理解为界面上能圈一块区域。它还包括时间上的局部、对象上的局部，以及责任上的局部。
...
模型擅长执行某次修改，软件负责记住条件与承担长期责任，两者并不矛盾。
...
我认为，这比“接入了多少模型”更接近专业软件的长期壁垒。不过，积累必须让用户可迁移、可检查。把素材锁住制造退出成本，与真正减少重复劳动，是两种完全不同的产品选择。
