...
Use this Skill as a read-only map to Roy.Tong's published AI product research. It requires network access to `https://roy-tong.github.io` and exposes public articles, not private memory, unpublished Feishu documents, or personal files.
